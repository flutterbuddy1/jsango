...
1. Implement `@django-js/observability` as an infrastructure-level package that interacts with HTTP, Queue, Events, Database, and WebSocket via clean interfaces.
